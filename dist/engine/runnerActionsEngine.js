...
class RunnerActionEngine {
    ...
    abort(id, { ...instance }) {
        try {
            const atualStatus = properties_1.default.checkStatusByID(id, { ...instance });
            if (atualStatus == 'occurring' || atualStatus == 'locked' || atualStatus == 'paused' || atualStatus == 'finished') {
    ...
    resume(id, instance) {
        try {
            ...
            if (atualStatus == 'paused') {
                properties_1.default.changePropetieByID(id, instance, 'status', 'occurring');
...
exports.RunnerActionEngine = RunnerActionEngine;
exports.default = new RunnerActionEngine();
//# sourceMappingURL=runnerActionsEngine.js.map